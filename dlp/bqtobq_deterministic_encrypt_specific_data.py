...
def deidentify_table_replace_with_info_types(
    ...
    condition_expression = {"conditions":[
                                {"field":{
                                  ...
                                  "operator":"EQUAL_TO",
                                  "value":{
                                     "integer_value":"1"   ##This is a specific value for which encryption will be applied
                                        }
                                    }
                                ]
                            }
            ...
            "field_transformations": [
                {
                    ...
                    "primitive_transformation": {
                        ...
                        "fields": [{"name": "credit_card_num"}],  # Customize this to your column name
                },
                # Add more field_transformations here for other sensitive columns if needed
            ]
        }
    }
