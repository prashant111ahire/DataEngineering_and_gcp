#Pupose: This code will performed the DLP with deterministic encryption, this code is table to table operation performed and has to provide input dataset,table name,column name on which DLP needs to apply and also need to provide the output table name for DLP applied output
#For Enterprise use case the same code can be wrapped in the Dataflow job for execution.
            ...
            "field_transformations": [
                {
                    "primitive_transformation": {
                        "crypto_deterministic_config": {
                            "crypto_key": {
                                "kms_wrapped": {
                                    "wrapped_key": kms_wrapped_key_name_base64,
...
def deidentify_bigquery_table_replace_with_info_types(
    ...
    output_table_id: str,
    kms_key_name: str,
    kms_wrapped_key_name_base64: str,
) -> None:
...
deidentify_bigquery_table_replace_with_info_types(
    ...
    kms_wrapped_key_name_base64=kms_wrapped_key_name_base64,
)
